...
class Migrating
{
    public function __construct($database_path, $vendor_path = __DIR__)
    {
    ...
    private function reset()
    {
        ...
        foreach ($migratedFiles->all as $mFile) {
    ...
    public static function generateSlug($phrase, $maxLength, $allow_slash = false, $toLower = true)
    {
    ...
    public static function generateFileSlug($phrase, $toLower = true)
    {
