...
class DataMapper implements IteratorAggregate {
	...
	public function __construct($id = NULL, $config_file = null)
	{
		...
		if ($is_dmz)
		{
			...
			DataMapper::$config = require $config_file;
	...
	public function __get($name)
	{
		...
		if($name == 'db')
		{
                        $this->db = \elanpl\DM\DB\Connection::getInstance(DataMapper::$config['db_config_file']);    
